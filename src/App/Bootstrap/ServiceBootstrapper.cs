using DcaBot.App.Commands;
using DcaBot.ChainProviders.Evm;
using DcaBot.ChainProviders.Transport;
using DcaBot.ChainProviders.Utxo;
using DcaBot.Cryptography.Derivation;
using DcaBot.Cryptography.Vault;
using DcaBot.Engine.Analytics;
using DcaBot.Engine.Domain.Contracts;
using DcaBot.Engine.Networks;
using DcaBot.Engine.Options;
using DcaBot.Engine.Orchestration;
using DcaBot.Persistence.Stores;
using Microsoft.Extensions.Logging;
using Microsoft.Extensions.Options;

namespace DcaBot.App.Bootstrap;
